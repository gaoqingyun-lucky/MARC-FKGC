...
# from trainer import *
import json
from SVD_complex_relation_trainer import *
import os
...
if __name__ == '__main__':
    ...
    params = get_params()
    params['dataset'] = 'NELL-One' #NELL-One FB15K-One
    params['data_path'] = './dataset/Nell-HiRe'
    params['few'] = 9
    params['prefix'] = "QR_CR_latent10_nellfew9_exp1" # 15K new_diffusion_latent27_Nell-HiRe_few5_exp1
    params['latent_num'] = 10
    params['embed_dim'] = 100
    # params['step'] = 'test'
    # params['eval_ckpt'] = '8000'
    # params['batch_size'] = 2
    # params['epoch'] = 4000
    # params['g_batch'] = 4
    print("---------Parameters---------")
