...
def get_params():
    ...
    args.add_argument("-bs", "--batch_size", default=16, type=int)#128
    ...
    args.add_argument("-max_neighbor", "--max_neighbor", default=5, type=int)#200
    ...
    args.add_argument("--K", default=5, type=int)#10
    args.add_argument("--g_batch", default=64, type=int)#512
